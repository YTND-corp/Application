...
class SortViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun getSortList() {
        ...
        items.add(MainFilterAdapter.SortItem(SharedFilterViewModel.SelectedFitlerDto.Companion.Sort.NewDiscount()))
        items.add(MainFilterAdapter.SortItem(SharedFilterViewModel.SelectedFitlerDto.Companion.Sort.Discount()))
